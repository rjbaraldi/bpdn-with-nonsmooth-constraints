%% load data
close all;  clear, clc; 
svfile = '/Users/bobby/Dropbox (uwamath)/TextOnly/IEEEversion_revised/missing_r1_7/';
% svfile = '/home/rbaraldi/Dropbox (uwamath)/TextOnly/IEEEversion_revised/missing_r1_7/'; 
...
disp(numel(params_i.indm))
mass(i) = sum(sum(sum(abs(b)))); 
