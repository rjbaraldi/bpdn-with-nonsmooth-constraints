function [Out] = CLini(M,N,AC,NBSCALES,NBANGLES_COARSE)

% CLini - Initialization in order to use CL or CLn
%
% CLini(M,N,AC,NBSCALES,NBANGLES_COARSE)
...
In = complex( randn(M,N),randn(M,N) );
