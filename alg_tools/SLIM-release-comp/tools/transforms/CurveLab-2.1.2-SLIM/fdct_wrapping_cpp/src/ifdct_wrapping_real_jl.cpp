...
extern "C" {
#include <complex.h>
void jl_ifdct_wrapping_real(int, int, int, int, int, int, int, size_t, double*, double*);
}

void jl_ifdct_wrapping_real(int m, int n, int nbscales, int nbangles_coarse, int all_crvlts,
        int real_crvlts, int zero_finest,
        size_t cl, double *C, double *X) {
